        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="lg:pl-12">
              ...
              <p className="font-sans text-neutral-600 text-base leading-relaxed mt-6">Depuis plus de 12 ans, la Communauté des Messagers de Dieu porte un message d&apos;espérance, de réconciliation et de transformation sociale.</p>
